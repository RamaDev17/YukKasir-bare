            ...
            <ScrollView style={styles.body}>
                ...
                <View style={styles.toko}>
                    <View style={styles.cardToko}>
                        ...
                        <Image source={StoreFront} resizeMode="cover" style={{ width: 70, height: 70, tintColor: COLORS.white }} />
                ...
                <View style={styles.row1}>
                    <TouchableOpacity style={styles.cardMenu} onPress={() => {navigation.navigate("ProductPage")}} >
                        <Image source={Product} resizeMode="cover" style={{ width: 70, height: 70, tintColor: COLORS.primary }} />
                        <Text style={styles.textCardMenu}>Produk</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.cardMenu} onPress={() => { navigation.navigate("TransaksiPage") }}>
                        <Image source={Dolar} resizeMode="cover" style={{ width: 70, height: 70, tintColor: COLORS.primary }} />
                ...
                <View style={styles.row1}>
                    <TouchableOpacity style={styles.cardMenu}>
                        <Image source={RiwayatTransaksi} resizeMode="cover" style={{ width: 70, height: 70, tintColor: COLORS.primary }} />
